...
export class Gravity extends SmartContract {
  ...
  try_getGravatar(owner: Address): CallResult<Gravity__getGravatarResult> {
    ...
    return CallResult.fromValue(
      new Gravity__getGravatarResult(
        value[0].toString(),
        value[1].toString(),
        value[2].toString()
      )
...
export class UpdateGravatarWikiCall extends EthereumCall {
  get inputs(): UpdateGravatarWikiCall__Inputs {
    return new UpdateGravatarWikiCall__Inputs(this);
  }

  get outputs(): UpdateGravatarWikiCall__Outputs {
    return new UpdateGravatarWikiCall__Outputs(this);
  }
}

export class UpdateGravatarWikiCall__Inputs {
  _call: UpdateGravatarWikiCall;

  constructor(call: UpdateGravatarWikiCall) {
    this._call = call;
  }
...
export class UpdateGravatarWikiCall__Outputs {
  _call: UpdateGravatarWikiCall;
